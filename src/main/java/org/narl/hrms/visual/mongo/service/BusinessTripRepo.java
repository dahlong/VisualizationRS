...
public interface  BusinessTripRepo { 
	
	public List<BusinessTrip> findAll();
	
	public List<BusinessTrip> findAll(Sort sort);
	
	public List<BusinessTrip> findByQuery(Query q);
	
	public List<BusinessTrip> findByMonth(String search);
	
	public List<BusinessTrip> findByOrg(String search);
